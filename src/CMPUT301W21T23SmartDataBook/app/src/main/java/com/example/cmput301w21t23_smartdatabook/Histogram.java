...
public class Histogram extends Experiment{
    ...
    public Histogram(String expName, String ownerUserID, String trialType, String description, boolean regionOn, int minTrials, int maxTrials, boolean isPublic, String date) {
